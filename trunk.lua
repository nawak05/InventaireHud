...
RegisterNetEvent("inventaire:openTrunkInventory")
AddEventHandler(
    "inventaire:openTrunkInventory",
...
RegisterNetEvent("inventaire:refreshTrunkInventory")
AddEventHandler(
    "inventaire:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
