...
Citizen.CreateThread(
    function()
		...
		ESX.TriggerServerCallback("Inventaire:getFastWeapons",function(cb)
			fastWeapons = cb
		end)
...
RegisterNUICallback(
    ...
    function(data, cb)
		...
		TriggerServerEvent("Inventaire:changeFastItem",data.slot,data.item.name)
		loadPlayerInventory()
		cb("ok")
	end
)
RegisterNUICallback(
    ...
    function(data, cb)
		...
		TriggerServerEvent("Inventaire:changeFastItem",0,data.item.name)
		loadPlayerInventory()
		cb("ok")
	end
)
